...
# continuous file
continuous_file = '11121whV.cdf'  # rotated file with a 1D, continuous time series
number_of_output_files = 4
burst_file_name = '11121whVwaves.cdf'
index_file_name = '11121whVwavesindecescdf.txt'
